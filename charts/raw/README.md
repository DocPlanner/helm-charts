...
The `DocPlanner/raw` chart takes a list of Kubernetes resources and
...
```
helm install raw-priority-classes DocPlanner/raw -f raw-priority-classes.yaml
```
...
```
helm install mysecret DocPlanner/raw -f values.yaml
```